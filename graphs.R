...
install.packages('dplyr',lib="E:/rwork/library")
install.packages('crayon',lib="E:/rwork/library")
install.packages('bindrcpp',lib="E:/rwork/library")
install.packages('cli',lib="E:/rwork/library")

library("crayon",lib.loc="E:/rwork/library")
library("cli",lib.loc="E:/rwork/library")
library("bindrcpp",lib.loc="E:/rwork/library")
library("dplyr",lib.loc="E:/rwork/library")
...
xlabels = c('A','B','C','D')
x/sum(x)
(labels2=paste(XLABEL,ROUND(X/SUM(X),2)*100,SEP='_'))
